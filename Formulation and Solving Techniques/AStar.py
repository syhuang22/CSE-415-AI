...
Student Name 1: Angus Hsieh
Student Name 2: James Huang
...
class AStar:
    ...
    def AStar(self, initial_state):
        ...
        # STEP 1a. Create a priority queue called OPEN
        self.OPEN = My_Priority_Queue()
        # STEP 1b. Assign g=0 to the start state.
        self.g[initial_state] = 0.0
        # STEP 1c. Create f
        f = {}
        f[initial_state] = self.g[initial_state] + self.h(initial_state)
        # STEP 1d. put the start date on the OPEN list
        self.OPEN.insert(initial_state, f[initial_state])
        ...
        while len(self.OPEN) > 0:
            ...
            for op in self.Problem.OPERATORS:
                if op.is_applicable(S):
                    ...
                    new_g = gs + edge_cost
                    f[new_state] = new_g + self.h(new_state)
                    fs = f[new_state]
